...
urlpatterns = [
    ...
    path('orders_table/order/<int:order_id>/create_offers', views.create_offers, name='create_offers'),
    path('orders_table/order/<int:order_id>/send_offers/', views.send_offers, name='send_offers')
]
